...
import { Fn as isProxy, Ft as onMounted, Kn as ref, Ot as nextTick, Yn as shallowRef, Zn as toRaw, gn as watch, nt as defineComponent, pt as h, zt as onUnmounted } from "./vue.runtime.esm-bundler-DfxAOUeA.js";
...
var compatProps = "3.5.42"[0] === "2" ? (internals, props) => Object.assign(internals, { attrs: props }) : (internals, props) => Object.assign(internals, props);
...
var Chart = defineComponent({
	...
	setup(props, param) {
		...
		const destroyChart = () => {
			...
			if (chart) {
				if (props.destroyDelay > 0) setTimeout(() => {
					chart.destroy();
					chartRef.value = null;
				}, props.destroyDelay);
				else {
...
function createTypedChart(type, registerables) {
	...
	return defineComponent({
		...
		setup(props, param) {
			...
			watch(() => chartComponentRef.value?.chart ?? null, (nextChart) => {
